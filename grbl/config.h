...
//* Custom Homing
#define HOMING_CYCLE_0 (1<<Z_AXIS)  // First home Z (Clamp).
#define HOMING_CYCLE_1 (1<<X_AXIS)  // Then home X (Left/Right)
#define HOMING_CYCLE_2 (1<<Y_AXIS)  // Them Home Y (Fwd/Back)
// #define HOMING_CYCLE_3 (1<<A_AXIS)  // Finally Home A (Pizza Tray)
