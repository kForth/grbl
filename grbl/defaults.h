...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_MAX_TRAVEL 80.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 165.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 190.0 // mm NOTE: Must be a positive value.
  ...
  #define DEFAULT_HOMING_DIR_MASK 7 // move negative dir X,Y,Z
